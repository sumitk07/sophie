...
class ProfileController extends GetxController {
  ...
  void onInit() {
    ...
    if (_authController.user.value != null) {
      ...
      // dobController.text =  _authController.user.value!.dateOfBirth;
      // phoneNoController.text = _authController.user.value!.;
      phoneNoController.text = _authController.user.value!.phone ?? "";
    }
    super.onInit();
  }
  ...
  Future<void> updateProfile() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        _authController.setUserDetail(response.data["data"]["userDetail"]);
      }
    } catch (err) {
      log(err.toString());
    } finally {
